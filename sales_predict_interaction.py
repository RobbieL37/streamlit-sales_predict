...
#grid_return = AgGrid(std_data.head(10), editable=True, reload_data=False)
#st.mtd_data = pd.DataFrame(grid_return['data']))
...
st.text('Please update numbers in the columns to get the prediction')
